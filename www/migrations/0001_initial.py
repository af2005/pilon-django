    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', shortuuidfield.fields.ShortUUIDField(blank=True, default=shortuuid.main.ShortUUID.uuid, editable=False, max_length=22, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_entities', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entity_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='www.entity')),
                ('markdown', markdownfield.models.MarkdownField(blank=True, default='', rendered_field='markdown_rendered', use_editor=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entities', models.ManyToManyField(related_name='labels', to='www.Entity')),
            ],
            options={
                'abstract': False,
            },
