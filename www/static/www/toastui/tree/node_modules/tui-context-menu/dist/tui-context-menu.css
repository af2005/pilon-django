 ...
 */
@charset "utf-8";
.tui-contextmenu ul, .tui-contextmenu li {
    list-style: none;
}
...
.tui-contextmenu-button.tui-contextmenu-selected, .tui-contextmenu-button.tui-contextmenu-selected:hover {
    background-color: #f4f4f4;
}

.tui-contextmenu-button:hover {
    background-color: #f4f4f4;
}
